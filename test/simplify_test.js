...
suite(path.basename(__filename), function () {
  ...
  suite('divideSubexpressions', function () {
    test('sorts and dedupes scopes', function () {
      assert.deepEqual(utils.simplifyScopeExpression.divideSubexpressions(['scope:1', 'scope:*', 'scope:1']), {
        scopes: ['scope:*', 'scope:1'],
        allOfs: [],
        anyOfs: [],
      });
    });
    test('returns nonscopes', function () {
      assert.deepEqual(
        utils.simplifyScopeExpression.divideSubexpressions(['scope:1', {AnyOf: ['scope:2']}, {AllOf: ['scope:3']}]),
        {
          scopes: ['scope:1'],
  ...
  suite('simplification', function () {
    ...
    t('single scope simplifies to itself', 'scope:1', 'scope:1');
    t('empty AnyOf', {AnyOf: []}, {AnyOf: []});
    t('empty AllOf', {AllOf: []}, {AllOf: []});
    t('AnyOf simplifies to itself', {AnyOf: ['scope:1', 'scope:2']}, {AnyOf: ['scope:1', 'scope:2']});
    t('AllOf simplifies to itself', {AllOf: ['scope:1', 'scope:2']}, {AllOf: ['scope:1', 'scope:2']});
    t(
      'AnyOf list of scopes duplicates are removed',
      {AnyOf: ['scope:1', 'scope:2', 'scope:1']},
      {AnyOf: ['scope:1', 'scope:2']},
    );
    t(
      'AnyOf list of subexpressions duplicates are removed',
      {AnyOf: ['scope:1', {AllOf: ['scope:2', 'scope:3']}, {AllOf: ['scope:2', 'scope:3']}]},
      {AnyOf: ['scope:1', {AllOf: ['scope:2', 'scope:3']}]},
    );
    t(
      'AllOf list of subexpressions duplicates are removed',
      {AllOf: ['scope:1', {AnyOf: ['scope:2', 'scope:3']}, {AnyOf: ['scope:2', 'scope:3']}]},
      {AllOf: ['scope:1', {AnyOf: ['scope:2', 'scope:3']}]},
    );
    t(
      'AllOf list of scopes duplicates are removed',
      {AllOf: ['scope:1', 'scope:2', 'scope:1']},
      {AllOf: ['scope:1', 'scope:2']},
    );
    t(
      'AnyOf list of scopes is not normalized but is sorted',
      {AnyOf: ['scope:1', 'other', 'scope:2', 'scope:*']},
      {AnyOf: ['other', 'scope:*', 'scope:1', 'scope:2']},
    );
    t(
      'AllOf list of scopes is normalized',
      {AllOf: ['scope:1', 'other', 'scope:2', 'scope:*']},
      {AllOf: ['other', 'scope:*']},
    );
    t('AllOf one scope reduces to that scope', {AllOf: ['scope:1']}, 'scope:1');
    t('AnyOf one scope reduces to that scope', {AnyOf: ['scope:1']}, 'scope:1');
    t(
      'AllOf list of scopes and subexpressions, scopes are normalized',
      {AllOf: ['scope:1', {AnyOf: ['other2', 'other3']}, 'other', 'scope:*']},
      {AllOf: ['other', 'scope:*', {AnyOf: ['other2', 'other3']}]},
    );
    t(
      'AnyOf list of scopes and subexpressions, scopes are sorted but not normalized',
      {AnyOf: ['scope:1', {AllOf: ['other2', 'other3']}, 'other', 'scope:*']},
      {AnyOf: ['other', 'scope:*', 'scope:1', {AllOf: ['other2', 'other3']}]},
    );
    t(
      'subexpressions of AnyOf are also simplified',
      {AnyOf: ['other', {AllOf: ['other2', 'other3', 'other2']}]},
      {AnyOf: ['other', {AllOf: ['other2', 'other3']}]},
    );
    t(
      'subexpressions of AllOf are also simplified',
      {AllOf: ['other', {AnyOf: ['other2', 'other3', 'other2']}]},
      {AllOf: ['other', {AnyOf: ['other2', 'other3']}]},
    );
    t(
      'deeply-nested AllOf: [AllOf: ..] simplified to just AllOf: [..] and normalized',
      {
        AllOf: [
          'scope1',
          {AllOf: ['scope2', 'scope3a', 'scope3b', {AllOf: [{AnyOf: ['other1', 'other2']}, 'scope4', 'scope3*']}]},
        ],
      },
      {AllOf: ['scope1', 'scope2', 'scope3*', 'scope4', {AnyOf: ['other1', 'other2']}]},
    );
    t(
      'parallel AnyOfs within AllOf are not coalesced',
      {AllOf: [{AnyOf: ['scope1', 'scope2']}, {AnyOf: ['scope2', 'scope3']}]},
      {AllOf: [{AnyOf: ['scope1', 'scope2']}, {AnyOf: ['scope2', 'scope3']}]},
    );
    t(
      'deeply-nested AnyOf: [AnyOf: ..] simplified to just AnyOf: [..]',
      {
        AnyOf: [
          'scope1',
          {AnyOf: ['scope2', 'scope3a', 'scope3b', {AnyOf: [{AllOf: ['other1', 'other2']}, 'scope4', 'scope3*']}]},
        ],
      },
      {AnyOf: ['scope1', 'scope2', 'scope3*', 'scope3a', 'scope3b', 'scope4', {AllOf: ['other1', 'other2']}]},
    );
    t(
      'parallel AllOfs within AnyOf are not coalesced',
  ...
  test('simplify a complex expression from a queue error', function () {
    ...
    const needed = utils.removeGivenScopes(
      ['scope1', 'queue:route:a', 'queue:create-task:medium:some/workerpool'],
      expr,
    );
